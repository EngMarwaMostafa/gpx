...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static final CameraPosition initialLocation = CameraPosition(
    target: LatLng(30.130412603920806, 31.311941476736276),
    zoom: 14.4746,
  );
  ...
  void getCurrentLocation() async {
    try {
      ...
      var _locationSubscription = this._locationSubscription;
  ...
  @override
  void dispose() {
    final _locationSubscription = this._locationSubscription;
    if (_locationSubscription != null) {
      _locationSubscription.cancel();
    }
    super.dispose();
